...
function questions(quesId, quesType, comprehensionId, laqId, laqParentId, correctAnswer, allottedMarks, negMarks, quesKeyPair, keyboardType, 
		...
		SARecordingTime,OverwritePreviousRecording,typeOfProgrammingLanguage,programmingLanguageName,reEditQues,reVisitQues,flagforReVistQues,maxTime,schemeInterval,
		assignedSchemeMarks,isQuesMand,isQuesMandUnanswered,plainOrRichText, considerLeadingorTrailingSpaces, ignoreWhiteSpacesInTheResponse,punctuationRequiredduringEvaluation, selectedStatus,comments,sequenceNumber,SAThinkTime,optionCount){
...
function secBean(secName,answered,notanswered,marked,markedAndAnswered,isOptional,secType,questions, hasOptionalQuestion,secId,difficultyLevel,diffcultyLabels,displayNumberPanel,groupAllQuestions,secCount,autoSave,showMarkForReviewButtopn){
	this.secId = secId;
